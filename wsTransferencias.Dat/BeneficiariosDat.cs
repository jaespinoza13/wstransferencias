...
namespace wsTransferencias.Dat
{
    public class BeneficiariosDat
    {
        ...
        public BeneficiariosDat ( SettingsApi serviceSettings )
        {
            ...
            var canal = GrpcChannel.ForAddress( serviceSettings.servicio_grpc_sybase, new GrpcChannelOptions { HttpHandler = handler } );
        ...
        public RespuestaTransaccion add_cuentas_beneficiarios ( ReqAddBeneficiario obj_beneficiario )
        {
            ...
            try
            {
                ...
                Funciones.llenar_datos_auditoria_salida( ds, obj_beneficiario );
                ...
                ds.ListaPEntrada.Add( new ParametroEntrada { StrNameParameter = "@int_ente_registra", TipoDato = TipoDato.Integer, ObjValue = obj_beneficiario.str_ente } );
            ...
            catch(Exception exception)
            {
                ...
                Funciones.SaveExcepcionDataBaseSybase( _settings, obj_beneficiario, MethodBase.GetCurrentMethod()!.Name, exception, str_clase );
                throw new Exception( obj_beneficiario.str_id_transaccion )!;
            }
            return respuesta;
        }
        ...
        public RespuestaTransaccion validar_benef_otras_ctas_mego ( ReqValidaBeneficiario obj_beneficiario )
        {
            RespuestaTransaccion respuesta = new RespuestaTransaccion();
            ...
            try
            {
                ...
                ds.ListaPEntrada.Add( new ParametroEntrada { StrNameParameter = "@int_sistema", TipoDato = TipoDato.Integer, ObjValue = obj_beneficiario.str_id_sistema } );
                ...
                ds.ListaPEntrada.Add( new ParametroEntrada { StrNameParameter = "@str_equipo", TipoDato = TipoDato.VarChar, ObjValue = obj_beneficiario.str_ip_dispositivo.ToString() } );
        ...
        public RespuestaTransaccion get_ctas_benef_transferencia ( ReqCuentasBeneficiario obj_beneficiario )
        {
            ...
            try
            {
                ...
                ds.ListaPEntrada.Add( new ParametroEntrada { StrNameParameter = "@int_ente", TipoDato = TipoDato.Integer, ObjValue = obj_beneficiario.str_ente } );
                ds.ListaPEntrada.Add( new ParametroEntrada { StrNameParameter = "@str_nem_tipo_beneficiario", TipoDato = TipoDato.VarChar, ObjValue = obj_beneficiario.str_tipo_beneficiario.ToString() } );
        ...
        public RespuestaTransaccion obtener_datos_pago_directo ( ReqValidaCuentaPagoDirecto req_valida_cuenta )
        {
            ...
            {
                DatosSolicitud ds = new DatosSolicitud();
                Funciones.llenar_datos_auditoria_salida( ds, req_valida_cuenta );

                ds.ListaPEntrada.Add( new ParametroEntrada { StrNameParameter = "@int_ente", TipoDato = TipoDato.Integer, ObjValue = req_valida_cuenta.str_ente } );
            ...
            catch(Exception exception)
            {
                respuesta.codigo = "001";
                respuesta.diccionario.Add( "str_error", exception.ToString() );
                Funciones.SaveExcepcionDataBaseSybase( _settings, req_valida_cuenta, MethodBase.GetCurrentMethod()!.Name, exception, str_clase );
                throw new Exception( req_valida_cuenta.str_id_transaccion )!;
